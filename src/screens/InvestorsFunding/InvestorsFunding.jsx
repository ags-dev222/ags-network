      ...
      >
        ...
        >
          <p className="text-lg text-muted-foreground font-['Montserrat']">
            We're connecting startups with investors. Our funding marketplace will help you find the right investment opportunities.
          </p>
        </motion.div>
      </motion.div>
    </div>
