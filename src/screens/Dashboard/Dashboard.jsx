...
const MetricCard = ({ title, value, change }) => {
  ...
  const arrowColor = isPositive ? 'text-green-300' : 'text-red-300';

  return (
    <div className="bg-green-700 text-white p-4 ml-4 mr-4 rounded-md shadow-md w-full">
...
const MembershipReport = () => (
  <div className="bg-gray-100 p-4 -mr-4 rounded-md ml-4  shadow-md h-60 w-full ">
...
const UpcomingEvents = () => (
  <div className="bg-green-700 text-white p-4 ml-8 mr-4 rounded-md shadow-md h-60 w-78 overflow-y-auto">
    ...
    <ul className="space-y-6">
      {[...Array(4)].map((_, index) => (
        <li key={index} className="flex items-center gap-2">
          ...
          />
          <span>Ghana Startup & SMEs Week</span>
        </li>
      ))}
    </ul>
  </div>
...
const Dashboard = () => {
  return (
    <div className="p-6 bg-white min-h-screen items-center space-y-6">
      {/* Header */}
      <h1 className="text-lg font-bold ml-4 mb-12 -mt-4 text-green-700">Dashboard</h1>

     {/* Metric Cards */}
     <div className="flex justify-between gap-4 w-full">
  <MetricCard title="Total Membership" value="10,000" change="+2.0%" />
  <MetricCard title="New Membership" value="2,000" change="-1.0%" />
  <MetricCard title="Total Investors" value="5,000" change="+3.0%" />
  <MetricCard title="Total Partnerships" value="1,000" change="+1.0%" />
</div>
